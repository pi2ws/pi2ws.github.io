...
| 10:00 – 11:00 AM  | Industry Panel I: XR & AI (Session Chair: [Chuchu Chen](https://www.chuchuchen.net/)) <details> Panelists: Ryan DuToit (Google), Melvin Fu (Pimax), Dinuka Abeywardena (Wing), Lingjie Liu (UPenn)  </details>  |
...
| 1:45 – 2:45 PM   | Industry Panel II: Robotics & AI (Session Chair: [Yixiang Deng](https://yixiangd.github.io/)) <details> Panelists: Fan Wang (Amazon Robotics), Lily Zhang (Latitude AI), Yafei Hu (RAI Institute), Yuliang Guo (Bosch Research), Shuntaro Yamazaki (Google)  </details>  |
| 2:45 – 3:00 PM   | Break                                                                    |
